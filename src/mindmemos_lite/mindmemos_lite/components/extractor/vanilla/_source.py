"""Source DTO construction owned by the Vanilla add extractor."""

from __future__ import annotations

from datetime import datetime

from ....typing import MemoryRequestContext, SourceRef, SourceWrite


def build_source_write(source_ref: SourceRef, context: MemoryRequestContext, now: datetime) -> SourceWrite:
    """Convert an extraction source reference into its persistence DTO."""
