"""DTO construction helpers shared by memory pipelines."""

from __future__ import annotations

from datetime import datetime

from ...typing import Entity, EntityWrite, MemoryRequestContext, SourceRef, SourceWrite


def build_source_write(source_ref: SourceRef, context: MemoryRequestContext, now: datetime) -> SourceWrite:
    """Convert a source reference into a persistence write DTO."""
...
def build_entity_write(
    ...
    """Convert an entity into a persistence write DTO."""
    return EntityWrite(
        entity_id=entity_id,
        account_id=context.account_id,
        project_id=context.project_id,
